...
class RegistrationView extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              // --- Role Selection (Obx দিয়ে র‍্যাপ করা) ---
              Obx(() => Row(
              ...
              // Obx দিয়ে চেক করা হচ্ছে রোল চেঞ্জ হলে ফিল্ড আসবে/যাবে
              Obx(() => controller.role.value == 'teacher'
                  ? Padding(
              ...
              SizedBox(height: 15),
              _buildTextField(controller.emailCtrl, "Email Address", Icons.email, isEmail: true),
              SizedBox(height: 15),
              _buildTextField(controller.passwordCtrl, "Password (6+ chars)", Icons.lock, isPassword: true),
              SizedBox(height: 15),

              // Obx দিয়ে Label চেঞ্জ হচ্ছে (Roll vs ID)
              Obx(() => _buildTextField(
                  controller.rollCtrl,
                  controller.role.value == 'student' ? "Roll Number" : "Teacher ID",
                  Icons.badge
              )),
              ...
              Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: Obx(() => DropdownButton<String>(
                    ...
                    items: controller.departments.map((dept) => DropdownMenuItem(value: dept, child: Text(dept))).toList(),
              ...
              Obx(() => controller.role.value == 'student'
                  ? Column(
                children: [
                  _buildTextField(controller.sessionCtrl, "Session (e.g. 2020-2021)", Icons.calendar_today),
                  SizedBox(height: 15),
                ],
              )
                  : SizedBox()),
  ...
  Widget _buildTextField(TextEditingController ctrl, String hint, IconData icon, {bool isPassword = false, bool isEmail = false, bool isNumber = false}) {
    return TextField(
      controller: ctrl,
